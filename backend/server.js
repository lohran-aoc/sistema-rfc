...
// IMPORTANTE: Render usa /tmp para arquivos temporários
// SQLite PRECISA de um caminho absoluto
const dbPath = process.env.DATABASE_PATH || '/tmp/guiamentos.db';
